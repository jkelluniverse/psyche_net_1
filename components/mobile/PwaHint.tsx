...
// add Psyche-Net to the Home Screen. Only shows on iOS Safari, not already
// installed, and never again once dismissed.
const KEY = "psyche-net-a2h-dismissed";
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <p className="text-sm text-ink">
            Add <span className="font-medium text-ink-strong">Psyche-Net</span> to your Home Screen for
